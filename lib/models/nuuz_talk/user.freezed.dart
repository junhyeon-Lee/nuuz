...
class _$_User implements _User {
  _$_User(
      ...
      @JsonKey(name: "profile_image") this.profile_image});
  ...
  @override
  String toString() {
    return 'User(name: $name, user_id: $user_id, profile_image: $profile_image)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, user_id, profile_image);
...
abstract class _User implements User {
  factory _User(
      ...
      @JsonKey(name: "user_id") final String? user_id,
      @JsonKey(name: "profile_image") final String? profile_image}) = _$_User;
