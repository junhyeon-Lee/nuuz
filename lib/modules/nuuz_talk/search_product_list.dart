...
Future<T?> showProductSearchPage<T>({
...
class CustomProductSearchDelegate extends SearchDelegate {
  final Function onTapItem;

  CustomProductSearchDelegate({
  ...
  Widget _renderQueryResult() {
    return Consumer(
      builder: (context, ref, child) {
        final reviewList = ref.watch(productController);
        return reviewList.when(
          data: (data) {
            final result = data.where((element) {
              return element.name.toLowerCase().contains(_queryTextController.text);
            });
            return Padding(
                                  ...
                                  NuuzContainer(
                                    child: Column(
                                      children: [
                                        ...
                                        //             child: e.imageUrl.length >0 ? CachedNetworkImage(imageUrl: e.imageUrl[0].toString()) : Image.asset(IconPath.nuuzAppIcon)),
                                        //         wSize(14),
                                        //         Expanded(
                                        //           child: Column(
      ...
      child: Scaffold(
        appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            title: Text('Talk_Serc_0006'.tr(), style: CustomTextStyle.headerL),
            centerTitle: true,
